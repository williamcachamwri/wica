...
export function WorldCupSticky() {
  ...
  return (
    ...
    >
      ...
      >
        {isLive ? (
          <span className="worldcup-sticky__toggle-dot" />
        ) : (
          <svg className="worldcup-sticky__toggle-trophy" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            <path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6" />
            <path d="M18 9h1.5a2.5 2.5 0 0 0 0-5H18" />
            <path d="M4 22h16" />
            <path d="M10 14.66V17c0 .55-.47.98-.97 1.21C7.85 18.75 7 20.24 7 22" />
